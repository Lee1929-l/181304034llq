    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <!-- <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo base_url("adminsystem/admin") ?>" class="nav-link">主页</a>
            </li> -->
            <!-- <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <!-- 消息开始 -->
            <!-- <div class="media">
                            <img src='<?= base_url() . "static/dist/img/user1-128x128.jpg" ?>' alt="用户头像"
            ...
            <!-- 消息开始 -->
            <!-- <div class="media">
                            <img src='<?= base_url() . "static/dist/img/user8-128x128.jpg" ?>' alt="用户头像"
            ...
            <!-- 消息开始 -->
            <!-- <div class="media">
                            <img src='<?= base_url() . "static/dist/img/user3-128x128.jpg" ?>' alt="用户头像"
                                class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    Nora Silvester
            ...
            <li class="nav-item">
                <a href="<?= base_url("login/logout") ?>" onClick="return confirm('确定退出登录?');">
                    <i class="fas fa-sign-out-alt"></i>
                </a>
                <!-- <a class="nav-link" data-widget="fullscreen" href="#" role="button">
                    <i class="fas fa-sign-out-alt">[退出登录]</i>
                </a> -->
            </li>
        </ul>
    </nav>
