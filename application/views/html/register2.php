...
<head>
    <title>企业用户注册</title>
    <meta charset="utf-8">
    <meta name="register2" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-2 mb-5">
                    <a class="btn btn-outline-primary" href='<?= base_url("home/register_fun") ?>'>个人用户</a>
                    <a class="btn btn-outline-primary" href='<?= base_url("home/register2_fun") ?>'>企业用户</a>
                </div>
                    ...
                    <form class="p-5 bg-white">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="user_company">企业名称</label>
                                <input type="text" id="user_company" class="form-control" placeholder="请输入企业名称">
                                <span id="company_tip" style="color:red"></span></br>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="user_name">联系人</label>
                                <input type="text" id="user_name" class="form-control" placeholder="请输入联系人">
                                <span id="name_tip" style="color:red"></span></br>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="user_tel">联系方式</label>
                                <input type="text" id="user_tel" class="form-control" placeholder="请输入联系方式">
    ...
    $(function() {
        ...
        $('#sub').click(function() {
            ...
            if (user_name.length = 0) {
                ...
                tmp_error_content.push('企业名称不能为空');
            }
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('home/register2_fun') ?>",
                data: data,
                dataType: "json",
